...
1. After successful upgrades for each environment, check metrics are still displaying and working well in Grafana
    - Check the dashboards in grafana: https://grafana.test.teacherservices.cloud, https://grafana.platform-test.teacherservices.cloud, https://grafana.teacherservices.cloud
